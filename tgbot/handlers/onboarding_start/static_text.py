description = "\n\nSelect one of the button below⤵️"
start_created = "Hi, {first_name}!" + description
start_not_created = "Welcome back, {first_name}!" + description
...
hash_used_before = "This hash used for another payments"
